...
def get_encoder(encoding, input_dim=3, 
    ...
    if encoding == 'None':
        ...
        from triplaneencoder.triplane_encoder import TriPlaneVolume
        encoder = TriPlaneVolume(
            ...
            lbound_auto_scale=kwargs['lbound_auto_scale'],
            upscale_ratio_bound = kwargs['upscale_ratio_bound'],
            upscale_levels=kwargs['upscale_levels'],
            wavelet_base_resolution = kwargs['wavelet_base_resolution']
        )
    else:
