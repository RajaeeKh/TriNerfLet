...
class NeuralRadianceMaterial(BaseMaterial):
    ...
    def configure(self) -> None:
        ...
        # print('self.n_input_dims = {}'.format(self.n_input_dims))
        self.network = get_mlp(self.n_input_dims, self.cfg.output_feature_dims , self.cfg.mlp_network_config)
    ...
    def forward(
        ...
        **kwargs,
        ...
        # print(viewdirs_embd.shape)
        # print(network_inp.shape)
        color = self.network(network_inp).view(*features.shape[:-1], -1)
